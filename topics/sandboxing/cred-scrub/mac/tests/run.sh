#!/usr/bin/env bash
# Test harness for the macOS cred-scrub.
#
...
# summary based on how many env-var categories survived and how many
# default-path redirects are still falling back to disk.
#
